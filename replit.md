...
- 2026-04-28 (final pass): Added a large coverage round to `EN_MILD` (clueless, weird, overacting, overconfident, slow person, pick me, try hard, wannabe, fake friend, backstabber, two faced, show off, drama queen, snake person), `EN_BULLYING` (waste of salary, dragging the team down, you are a burden, you lack basic skills, dead weight, everyone hates you, leave the group, you do not belong here, you need me, no one else will accept you, do what i say, stay quiet), `PASSIVE_AGG_PATTERNS` (interesting choice, bold of you to assume, sure if you say so, nice stupidity), and `THREAT_MARKERS` (watch yourself, you will regret it/this, try me, try me once, come outside, destroy you, i will destroy you). Added overlap dedup for EN_HATE (so "you are nothing without me" doesn't double-count "you are nothing") and BULLY_PATTERNS (so "nobody wants you here" doesn't triple-count). Sarcasm guard: positive words (nice/great/wow) are now neutralized when the same line carries any toxic / passive-aggressive / threat / bully signal. 54/54 tests pass.
